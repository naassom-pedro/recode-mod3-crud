...
namespace Viajou.Controllers
{
    public class DestinoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Cidade,Pais,Valor")] Destino destino)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Cidade,Pais,Valor")] Destino destino)
        {
            if (id != destino.Id)
            {
                return NotFound();
