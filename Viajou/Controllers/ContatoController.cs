...
namespace Viajou.Controllers
{
    public class ContatoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Mensagem")] Contato contato)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Mensagem")] Contato contato)
        {
            if (id != contato.Id)
            {
                return NotFound();
